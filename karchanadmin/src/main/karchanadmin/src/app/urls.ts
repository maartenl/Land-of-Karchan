...
export const urls = {
  ...
  BOARDS_URL: '/karchangame/resources/administration/boards',
  ...
  ITEMDEFINITIONS_URL: '/karchangame/resources/administration/itemdefinitions',
  ...
  GUILDS_URL: '/karchangame/resources/administration/guilds',
};
