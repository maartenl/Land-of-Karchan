...
-- MySQL dump 10.9
--
-- Host: localhost    Database: landofkarchan
-- ------------------------------------------------------
...
CREATE TABLE `mm_answers` (
  ...
  CONSTRAINT `mm_answers_ibfk_1` FOREIGN KEY (`name`) REFERENCES `mm_usertable` (`name`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `mm_guildranks`
--

DROP TABLE IF EXISTS `mm_guildranks`;
CREATE TABLE `mm_guildranks` (
  `title` varchar(255) NOT NULL default '',
  ...
  CONSTRAINT `mm_guildranks_ibfk_1` FOREIGN KEY (`guildname`) REFERENCES `mm_guilds` (`name`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Table structure for table `mm_guilds`
--

DROP TABLE IF EXISTS `mm_guilds`;
CREATE TABLE `mm_guilds` (
  `name` varchar(20) NOT NULL default '',
  `title` varchar(100) default NULL,
  `daysguilddeath` int(11) default '10',
  `maxguilddeath` int(11) default '10',
  `minguildmembers` int(11) default '20',
  `minguildlevel` int(11) default NULL,
  `guilddescription` text,
  `guildurl` varchar(255) default NULL,
  `bossname` varchar(20) NOT NULL default '',
  ...
  KEY `owner` (`owner`),
  CONSTRAINT `mm_guilds_ibfk_1` FOREIGN KEY (`bossname`) REFERENCES `mm_usertable` (`name`) ON UPDATE CASCADE,
  CONSTRAINT `mm_guilds_ibfk_2` FOREIGN KEY (`owner`) REFERENCES `mm_admin` (`name`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `mm_ignore`
--

DROP TABLE IF EXISTS `mm_ignore`;
CREATE TABLE `mm_ignore` (
  `fromperson` varchar(20) NOT NULL default '',
  `toperson` varchar(20) NOT NULL default '',
  PRIMARY KEY  (`fromperson`,`toperson`),
  KEY `toperson` (`toperson`),
  CONSTRAINT `mm_ignore_ibfk_1` FOREIGN KEY (`fromperson`) REFERENCES `mm_usertable` (`name`),
  CONSTRAINT `mm_ignore_ibfk_2` FOREIGN KEY (`toperson`) REFERENCES `mm_usertable` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `mm_itemtable` (
  ...
  KEY `itemid` (`itemid`),
  KEY `owner` (`owner`),
  CONSTRAINT `mm_itemtable_ibfk_2` FOREIGN KEY (`owner`) REFERENCES `mm_admin` (`name`) ON UPDATE CASCADE,
...
CREATE TABLE `mm_log` (
  ...
  `addendum` text,
  KEY `primaryindex` (`creation`,`name`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `mm_usertable` (
  ...
  CONSTRAINT `mm_usertable_ibfk_2` FOREIGN KEY (`guild`) REFERENCES `mm_guilds` (`name`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
