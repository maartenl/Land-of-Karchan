/*-------------------------------------------------------------------------
svninfo: $Id: ShoutCommand.java 1192 2009-10-20 05:42:27Z maartenl $
 ...
 * simple talking, that the scream can be heard in neighbouring rooms.
 */
public class ScreamCommand extends ShoutCommand
{
	...
	{
		return new ScreamCommand(getRegExpr());
	}
