...
public class NorthCommand extends NormalCommand
{
	...
	public boolean run(Player aPlayer) throws MmudException
	{
		...
		{
			Persons.sendMessageExcl(aPlayer, "%SNAME leave%VERB2 north.<BR>\r\n");
			aPlayer.setRoom(myRoom.getNorth());
			Persons.sendMessageExcl(aPlayer, "%SNAME appear%VERB2.<BR>\r\n");
		} else
		{
			aPlayer.writeMessage("You cannot go north.<BR>\r\n");
		}
		return true;
	}
	...
	{
		return new NorthCommand(getRegExpr());
	}
