...
public class AnswersPK implements Serializable
{
    ...
    public AnswersPK(String name, String question)
    {
        this.name = name;
    ...
    public boolean equals(Object object)
    {
        ...
        if (!(object instanceof AnswersPK))
        {
            return false;
        }
        AnswersPK other = (AnswersPK) object;
    ...
    {
        return "mmud.database.entities.AnswersPK[ name=" + name + ", question=" + question + " ]";
    }
