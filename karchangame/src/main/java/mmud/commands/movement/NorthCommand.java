...
public class NorthCommand extends NormalCommand
{
    ...
    public DisplayInterface run(String command, User aUser) throws MudException
    {
        ...
        {
            CommunicationService.getCommunicationService(myRoom).sendMessageExcl(aUser, "%SNAME leave%VERB2 north.<BR>\r\n");
        ...
        {
            CommunicationService.getCommunicationService(aUser).writeMessage("You cannot go north.<BR>\r\n");
        }
