...
@RolesAllowed("deputy")
@Transactional
@Path("/administration/itemdefinitions")
public class ItemDefinitionsRestService
{

  private static final Logger LOGGER = Logger.getLogger(ItemDefinitionsRestService.class.getName());
