...
public class CommandPK implements Serializable
{
    ...
    public CommandPK(int id, String command)
    {
        this.id = id;
    ...
    public boolean equals(Object object)
    {
        ...
        if (!(object instanceof CommandPK))
        {
            return false;
        }
        CommandPK other = (CommandPK) object;
        if (this.id != other.id)
        {
            return false;
        }
    ...
    {
        return "mmud.database.entities.game.CommandPK[ id=" + id + ", command=" + command + " ]";
    }
