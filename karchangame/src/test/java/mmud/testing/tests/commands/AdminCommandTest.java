...
public class AdminCommandTest extends MudTest
{
  ...
  public void froggingOn()
  {
    ...
    assertThat(marvin.getJackassing()).isZero();
    assertThat(CommunicationService.getCommunicationService(karn).getLog(0L).log).isEqualTo("Changed Marvin into frog (5).<br />\r\nMarvin is suddenly changed into a frog!<br />\r\n");
    assertThat(CommunicationService.getCommunicationService(marvin).getLog(0L).log).isEqualTo("You are suddenly changed into a frog!<br />\r\n");
  ...
  public void jackassingOn()
  {
    ...
    assertThat(CommunicationService.getCommunicationService(karn).getLog(0L).log).isEqualTo("Changed Marvin into jackass (5).<br />\r\nMarvin is suddenly changed into a jackass!<br />\r\n");
    assertThat(CommunicationService.getCommunicationService(marvin).getLog(0L).log).isEqualTo("You are suddenly changed into a jackass!<br />\r\n");
