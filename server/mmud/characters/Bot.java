/*-------------------------------------------------------------------------
cvsinfo: $Header: /karchan/mud/cvsroot/server/mmud/characters/Bot.java,v 1.6 2005/09/28 04:33:50 karn Exp $
...
public class Bot extends Person implements CommunicationListener
{
	...
	public void commEvent(Person aPerson, CommType aType, String aSentence)
	{
		...
		catch (MudDatabaseException e)
		{
			...
			// ignored, we will just say that an appropriate answer was not found.
		}
		if (anAnswer == null)
		{
