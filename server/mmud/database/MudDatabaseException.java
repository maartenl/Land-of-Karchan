...
/**
 * The exception thrown when errors occur with the database.
 */ 
public class MudDatabaseException extends MudException 
{
	 ...
	 */
	public MudDatabaseException(String aString)
	{
		super(aString);
	}
	 ...
	 */
	public MudDatabaseException(String aString, Throwable aThrowable)
	{
