/*-------------------------------------------------------------------------
cvsinfo: $Header: /karchan/mud/cvsroot/server/mmud/commands/SouthCommand.java,v 1.9 2005/09/15 04:50:00 karn Exp $
...
public class SouthCommand extends NormalCommand
{
	...
	throws MudException
	{
		...
		{
			Persons.sendMessageExcl(aUser, "%SNAME leave%VERB2 south.<BR>\r\n");
