/*-------------------------------------------------------------------------
cvsinfo: $Header: /karchan/mud/cvsroot/server/mmud/commands/ReadRpgBoardCommand.java,v 1.3 2005/09/15 04:50:00 karn Exp $
 ...
 */
public class ReadRpgBoardCommand extends ReadBoardCommand
{

	public ReadRpgBoardCommand(String aRegExpr)
	{
		super(aRegExpr);
	}
	...
	{
		return new ReadRpgBoardCommand(getRegExpr());
	}
