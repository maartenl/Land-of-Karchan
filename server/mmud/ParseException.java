...
/**
 * Exception thrown regarding the parsing of the command issued in the mud.
 */
public class ParseException extends MudException
{
	...
	{
		super(Constants.UNABLETOPARSEPROPERLY);
	}
	...
	{
		super(Constants.UNABLETOPARSEPROPERLY + " " + aMessage);
	}
