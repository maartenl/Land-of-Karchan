...
//	cgiHeaderContentType("text/html");
	...
	printf("\r\n");
	printf("<A\r\n");
	printf("HREF=\"%s?command=quit&name=%s&password=%s&frames=3\" \r\n", MudExe, name, password);
	printf("TARGET=_top ");
	...
	printf("</A><P>\r\n");
	printf("\r\n");
	printf("<A HREF=\"%s?command=sleep&name=%s&password=%s&frames=3\" onMouseOver=\"img_act('toc1')\"\r\n", MudExe, name, password);
	...
	printf("</A><P>\r\n");
	printf("<A HREF=\"%s?command=clear&name=%s&password=%s&frames=3\" onMouseOver=\"img_act('toc1')\"\r\n", MudExe, name, password);
	printf("TARGET=\"statusFrame\"\r\n");
	...
	printf("<AREA SHAPE=\"POLY\" COORDS=\"0,0,33,31,63,0,0,0\" HREF=\"%s?command=n&name=%s&password=%s&frames=3\" TARGET=\"statusFrame\">\r\n", MudExe, name, password);
	printf("<AREA SHAPE=\"POLY\" COORDS=\"0,63,33,31,63,63,0,63\" HREF=\"%s?command=s&name=%s&password=%s&frames=3\" TARGET=\"statusFrame\">\r\n", MudExe, name, password);
	printf("<AREA SHAPE=\"POLY\" COORDS=\"0,0,33,31,0,63,0,0\" HREF=\"%s?command=w&name=%s&password=%s&frames=3\" TARGET=\"statusFrame\">\r\n", MudExe, name, password);
	printf("<AREA SHAPE=\"POLY\" COORDS=\"63,0,33,31,63,63,63,0\" HREF=\"%s?command=e&name=%s&password=%s&frames=3\" TARGET=\"statusFrame\">\r\n", MudExe, name, password);
	printf("</MAP>\r\n");
	printf("\r\n");
	printf("<P>\r\n");
