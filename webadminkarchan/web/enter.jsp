...
<html>
    <head>
        ...
        <title>Land of Karchan - Admin Logon Screen</title>
...
<input type="text" maxlength="19" size="36" name="j_username"></td>
</tr>
<tr>
	<td>
	Password:</td><td>
<input type="password" name="j_password" size="36" maxlength="39"></td>
</tr>
