...
try {
   String[] columns = {"creation", "title", "description", "answer", "name", "closed"};
   String[] displays = {"Id", "Title", "Descripton", "Answer", "Name", "Is Closed"};
   processor = FormProcessorFactory.create("bugs",
