...
<H1><IMG SRC="/images/gif/dragon.gif" alt="dragon">Admin Pages</H1>
...
Welcome to the Admin Pages.<p/>
You are logged in as <%= itsPlayerName %>.<p/>
Your current session id is <%= itsPlayerSessionId %>.
